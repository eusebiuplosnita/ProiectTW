 ...
 */
	Configure::write('Security.salt', 'sadfdgdfgfghfghfgffgfgfgf');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '1234567896554345675423');
...
define("SITE_URL", 'http://localhost/proiect/');